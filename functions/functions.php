        ...
        if(strlen($content) > 250){
            ...
            if(strlen($upload_image) >= 1 and strlen($content) >= 1){
                ...
                if($upload_image=='' && $content==''){
                    echo "<script>alert('Error occured while uploading the Post!')</script>";
                    echo "<script>window.open('home.php','_self')</script>";
                }else{
                    if($content==''){
                        move_uploaded_file($img_temp,"../imagepost/$upload_image.$random_number");
...
function get_posts(){
                ...
                <div class='panel panel-info'>
                  <div class='panel-body'>
                    <form action='' method='post' class='form-inline'>
                      <textarea placeholder='Write a comment' class='pb-cmnt-textarea' name='comment'></textarea>
    ...
    function search_user(){
        ...
        if(isset($_GET['search_user_btn'])){
            $search_querry = htmlentities($_GET['search_user']);
            $get_user = "select * from users where f_name like '%$search_querry%' OR
            l_name like '%$search_querry%' OR user_name like '%$search_querry%'";
        }
        else{
