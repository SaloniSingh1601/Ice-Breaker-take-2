  ...
  <body>
      <div class="row">
          <div class="col-sm-12">
              <div class="well">
                  <center>
                    <h2 style="color:white;"><strong>Ice-Breaker</strong></h2>
                  </center>
              </div>
          </div>
      </div>
              ...
              <div class="main-content">
                  ...
                  <div class="l_pass">
                      <form action="" method="post">
                          ...
                          <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                              <input id="password" type="password" class="form-control" name="pass1" placeholder="Re-enter Password" required>
                          </div><br />
                          <center>
      ...
      if(isset($_POST['change'])){
        ...
        if($pass == $pass1){
            if(strlen($pass) >= 6 && strlen($pass) <= 60){
                ...
                echo "<script>alert('Your password should be greater than 6 chars')</script>";
            }
        }
        else{
